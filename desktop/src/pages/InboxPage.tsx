...
const InboxPage: React.FC = () => {
  ...
  const { recentActivity, weekCount, isLoading: activityLoading } = useInboxActivityFeed(
    DISPLAY_LIMITS.RECENT_ACTIVITY_COUNT
  );
  ...
  return (
    <div className="p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <DashboardHeader
          onUploadFiles={handleSelectFiles}
          onUploadFolder={handleSelectFolder}
      ...
      <FolderWatchManager
        ...
        onStatusChange={refetchWatchStatus}
      />
    </div>
  );
};
