...
export const DocumentListItem: React.FC<DocumentListItemProps> = ({ document, onTagClick }) => {
    ...
    >
      <div className="flex items-start justify-between">
        <div className="flex items-start space-x-4 flex-1">
          {/* File Icon */}
          <div className="flex-shrink-0 text-2xl">{getMimeTypeIcon(document.mime_type)}</div>
          ...
          <div className="flex-1 min-w-0">
            ...
            {document.text_preview && (
              <div className="mt-3 p-2 bg-muted/30 rounded text-xs">
                ...
                <div className="text-foreground italic">&ldquo;{document.text_preview}&rdquo;</div>
              </div>
            )}
            ...
            {document.tags && document.tags.length > 0 && (
              <div className="mt-3">
                ...
                <div className="flex flex-wrap gap-1">
                  {document.tags.slice(0, 8).map((tag) => (
                    <button
                      key={`${document.id}-tag-${tag}`}
            ...
            {document.original_path &&
              document.original_path !== getFileName(document.original_path) && (
