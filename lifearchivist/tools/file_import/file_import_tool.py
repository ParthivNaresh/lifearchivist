...
class FileImportTool(BaseTool):
    ...
    async def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        log_event("file_analysis_started", {
        ...
        if self.progress_manager and session_id:
            ...
            log_event("progress_tracking_started", {
                "file_id": file_id,
        ...
        try:
            ...
            log_event("vault_storage_completed", {
                "file_id": file_id,
                "file_hash": file_hash[:8],
            ...
            log_event("text_extraction_completed", {
                "file_id": file_id,
            ...
            if vault_result["existed"]:
                log_event("duplicate_check_started", {
                    "file_id": file_id,
                    "file_hash": file_hash[:8],
                    "vault_existed": True
                })
            ...
            log_event("document_creation_started", {
                "file_id": file_id,
            ...
            if not success:
                log_event("document_creation_failed", {
                    "file_id": file_id,
            ...
            log_event("document_status_updated", {
                "file_id": file_id,
                "status": "ready"
            })
            ...
            if self.progress_manager and session_id:
                ...
                log_event("progress_tracking_completed", {
                    "file_id": file_id,
                    "session_id": session_id
                })
            ...
            if self.progress_manager and session_id and "file_id" in locals():
                try:
                    ...
                    log_event("progress_error_failed", {
                        "file_id": file_id,
            ...
            if self.llamaindex_service and "file_id" in locals():
                try:
                    ...
                    log_event("metadata_update_failed", {
                        "file_id": file_id,
                        "original_error": str(e),
    ...
    async def _try_extract_text(
        ...
        if is_text_extraction_supported(mime_type):
            log_event("text_extraction_supported", {
                "file_id": file_id,
                "mime_type": mime_type,
                "file_hash": file_hash[:8]
            })
            ...
            log_event("text_extraction_skipped", {
                "file_id": file_id,
                "mime_type": mime_type,
    ...
    async def _try_extract_content_dates(self, file_id: str, text: str):
        ...
        if not should_extract_dates(text):
            log_event("date_extraction_skipped", {
                "file_id": file_id,
        ...
        log_event("date_extraction_started", {
            "file_id": file_id,
            "text_length": len(text),
        ...
        log_event("date_extraction_completed", {
            "file_id": file_id,
